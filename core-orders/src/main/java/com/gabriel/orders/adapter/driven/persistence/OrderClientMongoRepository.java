...
import com.gabriel.common.core.domain.model.id.OrderItemID;
...
@Repository
public class OrderClientMongoRepository implements OrderRepository {

    private final MongoCollection<Document> orderCollection;

    public OrderClientMongoRepository(MongoCollection<Document> orderCollection) {
